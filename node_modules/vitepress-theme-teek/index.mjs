...
var _sfc_main$Z = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const categoriesPageLink = computed(() => {
      const localeIndexConst = localeIndex.value;
      const localeName = localeIndexConst !== "root" ? `/${localeIndexConst}` : "";
      return withBase$1(`${localeName}${categoryConfig.value.path}${site.value.cleanUrls ? "" : ".html"}`);
    });
  ...
  setup(__props) {
    ...
    const updatePosts = computed(() => {
      ...
      return [
        ...
        { title: t("tk.articleUpdate.moreLabel"), url: archivesPath.value, frontmatter: {}, date: "" }
      ];
    });
    return (_ctx, _cache) => {
            ...
            [
              ...
              __props.item.children ? (openBlock(), createElementBlock("ul", {
                ...
                (openBlock(true), createElementBlock(
                  Fragment,
                  null,
                  renderList(__props.item.children, (child, i) => {
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(
        ...
        [
          !(unref(isCategoriesPage) || unref(isTagsPage)) ? renderSlot(_ctx.$slots, "teek-home-card-before", { key: 0 }) : createCommentVNode("v-if", true),
                ...
                return openBlock(), createElementBlock(
                  ...
                  [
                    ...
                    unref(windowTransition) ? (openBlock(), createElementBlock(
                      ...
                      { key: 0 },
                      [
                        _ctx.$slots[`${componentMap.value[item]?.slot}-before`] && !(unref(isCategoriesPage) || unref(isTagsPage)) ? (openBlock(), createElementBlock(
                          "div",
                          {
                            key: 0,
                            ref_for: true,
                        ...
                        createElementVNode(
                          ...
                          [
                            componentMap.value[item]?.show ? renderSlot(_ctx.$slots, componentMap.value[item]?.slot, { key: 0 }, () => [
                              (openBlock(), createBlock(
                                resolveDynamicComponent(componentMap.value[item]?.el),
                                mergeProps({ ref_for: true }, componentMap.value[item]?.props),
                                null,
                                16
                                /* FULL_PROPS */
                              ))
                        ...
                        _ctx.$slots[`${componentMap.value[item]?.slot}-after`] && !(unref(isCategoriesPage) || unref(isTagsPage)) ? (openBlock(), createElementBlock(
                          "div",
                          {
                            key: 1,
                            ref_for: true,
                      ...
                      [
                        ...
                        componentMap.value[item]?.slot && !(unref(isCategoriesPage) || unref(isTagsPage)) ? renderSlot(_ctx.$slots, `${componentMap.value[item]?.slot}-before`, { key: 0 }) : createCommentVNode("v-if", true),
                        ...
                        componentMap.value[item]?.slot && !(unref(isCategoriesPage) || unref(isTagsPage)) ? renderSlot(_ctx.$slots, `${componentMap.value[item]?.slot}-after`, { key: 2 }) : createCommentVNode("v-if", true)
                      ],
                      64
                      /* STABLE_FRAGMENT */
                    ))
          ...
          !(unref(isCategoriesPage) || unref(isTagsPage)) ? renderSlot(_ctx.$slots, "teek-home-card-after", { key: 1 }) : createCommentVNode("v-if", true)
        ],
        2
        /* CLASS */
      );
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(_sfc_main$k, {
        ...
        _: 1
        /* STABLE */
      }, 8, ["class", "icon", "title", "helper", "helper-desc", "tips", "disabled"]);
    };
  }
});
...
var _sfc_main$5 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const getLoginHandler = (searchParams) => {
        ...
        [
          ...
          withDirectives(createVNode(unref(Layout), {
            ...
            "doc-before": withCtx(() => [
              ...
              unref(teekConfig).articleAnalyze.imageViewer?.enabled ?? true ? (openBlock(), createBlock(unref(_sfc_main$_), { key: 1 })) : createCommentVNode("v-if", true),
              createVNode(unref(_sfc_main$Y)),
              unref(teekConfig).codeBlock.enabled ?? true ? (openBlock(), createBlock(unref(_sfc_main$R), { key: 2 })) : createCommentVNode("v-if", true),
              topTipConfig.value ? (openBlock(), createBlock(
                unref(_sfc_main$18),
                normalizeProps(mergeProps({ key: 3 }, unref(isBoolean$1)(topTipConfig.value) ? {} : topTipConfig.value)),
                null,
                16
                /* FULL_PROPS */
              )) : createCommentVNode("v-if", true),
              unref(teekConfig).sidebarTrigger ? (openBlock(), createBlock(unref(_sfc_main$3), { key: 4 }, {
                default: withCtx((scope) => [
