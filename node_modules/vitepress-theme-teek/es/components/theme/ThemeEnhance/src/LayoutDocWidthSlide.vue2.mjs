import { defineComponent, computed, watch, openBlock, createBlock, Transition, unref, withCtx, withDirectives, createVNode, normalizeClass, isRef, vShow } from 'vue';
...
import { docMaxWidthSlideStorageKey, layoutModeStorageKey, transitionName, ns, docMaxWidthVar } from './namespace.mjs';
