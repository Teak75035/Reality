import { defineComponent, ref, reactive, markRaw, openBlock, createElementBlock, unref, normalizeClass, createElementVNode, createCommentVNode, toDisplayString, Fragment, renderList, createVNode, withDirectives, withKeys, vModelDynamic, createBlock, resolveDynamicComponent } from 'vue';
...
import '../../../common/Message/src/instance.mjs';
