import { defineComponent, ref, computed, onBeforeUnmount, openBlock, createBlock, TransitionGroup, unref, normalizeClass, withCtx, createElementBlock, Fragment, renderList, withDirectives, resolveDynamicComponent, createCommentVNode, createElementVNode, toDisplayString, vShow } from 'vue';
                ...
                (openBlock(), createBlock(resolveDynamicComponent(feature.link ? "a" : "div"), {
                  ...
                  default: withCtx(() => [
                    feature.image ? (openBlock(), createElementBlock("img", {
                      key: 0,
                      class: "feature-img",
                      src: unref(withBase)(feature.image),
                      alt: feature.title,
                      "aria-label": feature.title
                    ...
                    createElementVNode("p", {
                      ...
                      class: "feature-title"
                    }, toDisplayString(feature.title), 9, _hoisted_3),
                    createElementVNode(
                      "p",
                      _hoisted_4,
