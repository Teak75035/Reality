import { defineComponent, resolveComponent, openBlock, createElementBlock, normalizeClass, unref, createTextVNode, toDisplayString, createElementVNode, createBlock, createCommentVNode, Fragment, renderList } from 'vue';
      ...
      return openBlock(), createElementBlock(
        ...
        [
          !__props.item.children ? (openBlock(), createElementBlock("a", {
            key: 0,
            href: __props.item.url && unref(withBase)(__props.item.url),
            ...
            __props.item.frontmatter?.titleTag ? (openBlock(), createBlock(unref(_sfc_main$1), {
              key: 0,
          ...
          ], 8, _hoisted_1)) : __props.item.children.length ? (openBlock(), createElementBlock(
            Fragment,
            { key: 1 },
            [
