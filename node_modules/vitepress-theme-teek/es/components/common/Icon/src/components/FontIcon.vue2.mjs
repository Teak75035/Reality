import { defineComponent, openBlock, createElementBlock, toDisplayString, normalizeClass, createElementVNode, createCommentVNode } from 'vue';
  ...
  setup(__props) {
    return (_ctx, _cache) => {
      return __props.iconType === "unicode" ? (openBlock(), createElementBlock(
        ...
        2
        /* CLASS */
      )) : __props.iconType === "symbol" ? (openBlock(), createElementBlock("svg", _hoisted_2, [
