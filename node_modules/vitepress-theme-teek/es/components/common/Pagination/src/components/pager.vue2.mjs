import { defineComponent, ref, computed, watchEffect, openBlock, createElementBlock, withKeys, normalizeClass, unref, createCommentVNode, Fragment, renderList, toDisplayString } from 'vue';
import 'vitepress';
import { useNamespace } from '../../../../../composables/useNamespace.mjs';
import 'vitepress-theme-teek/theme-chalk/tk-copy-banner.css';
import { useLocale } from '../../../../../composables/useLocale.mjs';
import '../../../../../composables/useZIndex.mjs';
import dArrowRightIcon from '../../../../../static/icons/dArrowRight.mjs';
import dArrowLeftIcon from '../../../../../static/icons/dArrowLeft.mjs';
import moreFilledIcon from '../../../../../static/icons/moreFilled.mjs';
      ...
      return openBlock(), createElementBlock(
        ...
        [
          ...
          showPrevMore.value ? (openBlock(), createElementBlock("li", {
            ...
            }, null, 8, _hoisted_3)) : (openBlock(), createElementBlock("span", {
              key: 1,
          ...
          (openBlock(true), createElementBlock(
            ...
            renderList(pagers.value, (pager) => {
              return openBlock(), createElementBlock("li", {
                ...
                tabindex: tabindex.value
              }, toDisplayString(pager), 11, _hoisted_5);
            }),
            128
            /* KEYED_FRAGMENT */
          )),
          showNextMore.value ? (openBlock(), createElementBlock("li", {
            ...
            }, null, 8, _hoisted_7)) : (openBlock(), createElementBlock("span", {
              key: 1,
              innerHTML: unref(moreFilledIcon)
            }, null, 8, _hoisted_8))
          ], 42, _hoisted_6)) : createCommentVNode("v-if", true),
          __props.pageCount > 1 ? (openBlock(), createElementBlock("li", {
            ...
            tabindex: tabindex.value
          }, toDisplayString(__props.pageCount), 11, _hoisted_9)) : createCommentVNode("v-if", true)
        ],
        34
