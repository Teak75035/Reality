import { cleanPathSpaces, replacePlaceholder, getFirstPathSegment, createRandomUuid } from './permalink.mjs';
...
const createComplexPermalink = (permalink, fileInfo, permalinkRules) => {
...
export { createCategory, createComplexPermalink, createCoverImg, createSimplePermalink };
