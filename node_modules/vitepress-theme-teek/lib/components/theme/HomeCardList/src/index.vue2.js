  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return Vue.openBlock(), Vue.createElementBlock(
        ...
        [
          !(Vue.unref(isCategoriesPage) || Vue.unref(isTagsPage)) ? Vue.renderSlot(_ctx.$slots, "teek-home-card-before", { key: 0 }) : Vue.createCommentVNode("v-if", true),
                ...
                return Vue.openBlock(), Vue.createElementBlock(
                  ...
                  [
                    ...
                    Vue.unref(windowTransition) ? (Vue.openBlock(), Vue.createElementBlock(
                      ...
                      { key: 0 },
                      [
                        _ctx.$slots[`${componentMap.value[item]?.slot}-before`] && !(Vue.unref(isCategoriesPage) || Vue.unref(isTagsPage)) ? (Vue.openBlock(), Vue.createElementBlock(
                          "div",
                          {
                            key: 0,
                            ref_for: true,
                        ...
                        Vue.createElementVNode(
                          ...
                          [
                            componentMap.value[item]?.show ? Vue.renderSlot(_ctx.$slots, componentMap.value[item]?.slot, { key: 0 }, () => [
                              (Vue.openBlock(), Vue.createBlock(
                                Vue.resolveDynamicComponent(componentMap.value[item]?.el),
                                Vue.mergeProps({ ref_for: true }, componentMap.value[item]?.props),
                                null,
                                16
                                /* FULL_PROPS */
                              ))
                        ...
                        _ctx.$slots[`${componentMap.value[item]?.slot}-after`] && !(Vue.unref(isCategoriesPage) || Vue.unref(isTagsPage)) ? (Vue.openBlock(), Vue.createElementBlock(
                          "div",
                          {
                            key: 1,
                            ref_for: true,
                      ...
                      [
                        ...
                        componentMap.value[item]?.slot && !(Vue.unref(isCategoriesPage) || Vue.unref(isTagsPage)) ? Vue.renderSlot(_ctx.$slots, `${componentMap.value[item]?.slot}-before`, { key: 0 }) : Vue.createCommentVNode("v-if", true),
                        ...
                        componentMap.value[item]?.slot && !(Vue.unref(isCategoriesPage) || Vue.unref(isTagsPage)) ? Vue.renderSlot(_ctx.$slots, `${componentMap.value[item]?.slot}-after`, { key: 2 }) : Vue.createCommentVNode("v-if", true)
                      ],
                      64
                      /* STABLE_FRAGMENT */
                    ))
          ...
          !(Vue.unref(isCategoriesPage) || Vue.unref(isTagsPage)) ? Vue.renderSlot(_ctx.$slots, "teek-home-card-after", { key: 1 }) : Vue.createCommentVNode("v-if", true)
        ],
        2
        /* CLASS */
      );
